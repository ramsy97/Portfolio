...
export const projects: Project[] = [
  {
    ...
    category: "Full-Stack",
    description: "A full-stack manufacturing monitoring application inspired by real-world production environments, designed to demonstrate real-time production monitoring, machine status tracking, downtime management, and Andon alerts.",
    longDescription: "A full-stack manufacturing monitoring application inspired by real-world production environments, designed to demonstrate real-time production monitoring, machine status tracking, downtime management, and Andon alerts.",
  ...
  },
  {
    ...
    category: "Full-Stack",
    description: "A portfolio project that combines production data analytics and machine learning to help analyze production performance, defects, downtime, and operational trends.",
    longDescription: "A portfolio project that combines production data analytics and machine learning to help analyze production performance, defects, downtime, and operational trends.",
  ...
  },
  {
    ...
    longDescription: "An enterprise-style CRM system built from a formal PRD, covering customers & contacts with timelines, lead scoring and conversion, an opportunities kanban pipeline with weighted forecasting, server-priced quotations with a manager approval workflow, SLA-driven support tickets, marketing campaigns with ROI tracking, role-specific reports, and admin tooling with a permission matrix and immutable audit logs.",
