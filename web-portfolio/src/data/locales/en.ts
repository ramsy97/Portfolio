export const en = {
  ...
  hero: {
    ...
    intro:
      "I build web applications and internal systems for business workflows — inventory, manufacturing, CRM, and management tools. I work across the stack, from database design and APIs to the interfaces people actually use.",
    ctaWork: "View Selected Work",
    ctaCv: "Download CV",
    location: "Based in Bekasi, Indonesia",
    ...
    rows: [
      {
        label: "Background",
        value:
          "Diploma III Information Systems · Manufacturing experience (PT Yamaha) · Self-taught into full-stack",
      },
      {
        label: "Focus",
        value:
          "Inventory · Manufacturing systems · CRM · POS · Attendance · IT service · REST APIs · Databases",
      },
      {
        label: "Roles",
  ...
  work: {
    ...
    moreNote: "Additional systems built during and after study.",
  },
  about: {
    label: "About",
    heading: "Systems that match how people actually work.",
    paragraphs: [
      "I'm a software engineer with a background in Information Systems and hands-on experience inside a manufacturing plant. That combination shaped how I approach software: I care about workflows, data accuracy, and systems that are practical for the people using them.",
      "Most of my projects are business applications — inventory, manufacturing monitoring, CRM, POS, and internal management tools. I work across the stack, but I'm most interested in the point where a messy operational problem becomes a clear data model and a usable interface.",
    ],
    mapLabel: "How my background shapes my work",
    map: [
      {
        title: "Manufacturing experience",
        desc: "Firsthand understanding of production workflows, quality control, and operational reporting.",
      },
      {
        title: "Information Systems",
        desc: "System analysis and database design as the foundation of every application.",
      },
      {
        title: "Full-stack development",
        desc: "Turning real workflows into shipped products — interface, API, and data.",
      },
    ],
  },
  experience: {
    label: "Experience",
    intro: "Career and education in brief.",
    ...
    jobs: [
      {
        ...
        summary:
          "Production role in a manufacturing environment, centered on production data, component inspection, and quality documentation.",
        bullets: [
          "Recorded and maintained daily production data for operational reporting.",
          "Performed component inspections and documented OK/NG results per quality procedures.",
          "Verified production and inspection records for data accuracy before QC submission.",
          "Collaborated with production and quality teams on operational records.",
        ],
        learned:
          "Hands-on understanding of manufacturing workflows, production data, and quality control — the foundation of my interest in building software for manufacturing, inventory, and operations.",
      },
    ],
    ...
    education: [
      {
        ...
        degree: "Diploma III — Information Systems",
        period: "2018 — 2021",
      ...
      },
      {
        ...
        details: [
          "Built and configured computer systems from scratch, covering hardware assembly, BIOS setup, and OS installation.",
  ...
  skills: {
    label: "Skills",
    intro: "The tools I reach for across the stack — and around it.",
  },
  github: {
    label: "GitHub",
    intro: "Source code for the projects above.",
    note: "20+ public repositories, mostly business applications and full-stack tools.",
    cta: "View GitHub profile",
  },
  contact: {
    label: "Contact",
    heading: "Have a project or opportunity?",
    intro: "I'm open to software development, IT, and technology-related opportunities.",
    ...
    messagePlaceholder: "Tell me about the project or the role.",
    sendMessage: "Send message",
    sending: "Sending…",
    sendSuccess: "Message sent — thank you. I'll reply soon.",
